    ...
    public static class VehicleData
    {
        ...
        public static class Vehicles
        {
            ...
            public static List<string> Sedans { get; } = new List<string>()
            {
                ...
                "ASEA2",
                "ASTEROPE",
                "CINQUEMILA", // The Contract Dlc - Requires b2545
                "COG55",
                "COG552",
                "COGNOSCENTI",
                "COGNOSCENTI2",
                "DEITY", // The Contract Dlc - Requires b2545
                "EMPEROR",
                "EMPEROR2",
                "EMPEROR3",
                "FUGITIVE",
                ...
                "IGNUS", // The Contract Dlc - Requires b2545
                "INGOT",
                "INTRUDER",
                "LIMO2",
                "PREMIER",
            ...
            {
                "ASTRON", // The Contract Dlc - Requires b2545
                "BALLER",
                "BALLER2",
                "BALLER3",
                "BALLER4",
                "BALLER5",
                "BALLER6",
                "BALLER7", // The Contract Dlc - Requires b2545
                "BJXL",
                "CAVALCADE",
                "CAVALCADE2",
                "CONTENDER",
                ...
                "FQ2",
                "GRANGER",
                "GRANGER2", // The Contract Dlc - Requires b2545
                "GRESLEY",
                "HABANERO",
                "HUNTLEY",
                "IWAGEN", // The Contract Dlc - Requires b2545
                "JUBILEE", // The Contract Dlc - Requires 
                "LANDSTALKER",
            ...
            public static List<string> Muscle { get; } = new List<string>()
            {
                ...
                "BUCCANEER",
                "BUCCANEER2",
                "BUFFALO4", // The Contract Dlc - Requires b2545
                "CHINO",
                "CHINO2",
                "CLIQUE",
                "COQUETTE3",
            ...
            public static List<string> Sports { get; } = new List<string>()
            {
                ...
                "COMET7", // The Contract Dlc - Requires b2545
                "COQUETTE",
            ...
            public static List<string> Super { get; } = new List<string>()
            {
                ...
                "BANSHEE2",
                "BULLET",
                "CHAMPION",  // The Contract Dlc - Requires b2545
                "CHEETAH",
                "CYCLONE",
                "DEVESTE",
                ...
                "VOLTIC2",
                "XA21",
                "ZENO", // The Contract Dlc - Requires b2545
                "ZENTORNO",
            ...
            public static List<string> Motorcycles { get; } = new List<string>()
            {
                ...
                "PCJ",
                "RATBIKE",
                "REEVER",  // The Contract Dlc - Requires b2545
                "RROCKET", // CASINO AND RESORT (MPVINEWOOD) DLC - Requires b2060
                "RUFFIAN",
                "SANCHEZ",
                "SANCHEZ2",
                "SANCTUS",
                "SHINOBI", // The Contract Dlc - Requires b2545
                "SHOTARO",
                "SOVEREIGN",
            ...
            public static List<string> OffRoad { get; } = new List<string>()
            {
                ...
                "PATRIOT3", // The Contract Dlc - Requires b2545
                "RANCHERXL",
                "RANCHERXL2",
                "RCBANDITO",
                "REBEL",
            ...
            public static List<string> Vans { get; } = new List<string>()
            {
                ...
                "YOUGA4", // The Contract Dlc - Requires b2545
            };
            #endregion
            #region Cycles
            ...
            public static List<string> Commercial { get; } = new List<string>()
            {
                ...
                "MULE3",
                "MULE4",
                "MULE5", // The Contract Dlc - Requires b2545
                "PACKER",
                "PHANTOM",
                "PHANTOM2",
                "PHANTOM3",
