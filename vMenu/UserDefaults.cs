...
namespace vMenuClient {
    ...
    #region Player Appearance
        public static int PAClothingAnimationType {
            get => GetSettingsInt("clothingAnimationType");
    ...
    #region Weapon Loadouts
        public static bool WeaponLoadoutsSetLoadoutOnRespawn {
            get => GetSettingsBool("weaponLoadoutsSetLoadoutOnRespawn");
    ...
    #region Personal Vehicle
        public static bool PVEnableVehicleBlip {
            get => GetSettingsBool("pvEnableVehicleBlip");
    ...
    #region Private functions
        ...
        /// <returns></returns>
        static bool GetSettingsBool(string kvpString)
        {
        ...
        static void SetSavedSettingsBool(string kvpString, bool newValue)
        {
            SetResourceKvp(SETTINGS_PREFIX + kvpString, newValue.ToString());
        }

        static float GetSettingsFloat(string kvpString)
        {
        ...
        static void SetSavedSettingsFloat(string kvpString, float newValue)
        {
            SetResourceKvpFloat(SETTINGS_PREFIX + kvpString, newValue);
        }


        static int GetSettingsInt(string kvpString)
        {
            // Get the current value.
        ...
        static void SetSavedSettingsInt(string kvpString, int newValue)
        {
