...
namespace vMenuClient {
    public class MainMenu : BaseScript {
        ...
        #region cleanup unused kvps
            ...
            if (!cleanupVersionChecked) {
                ...
                foreach (string kvp in tmp_kvp_names) {
                    if (currentCleanupVersion == 1 || currentCleanupVersion == 2) {
                        if (!kvp.StartsWith("settings_") && !kvp.StartsWith("vmenu") && !kvp.StartsWith("veh_") && !kvp.StartsWith("ped_") &&
                            !kvp.StartsWith("mp_ped_")) {
            ...
            if (EnableExperimentalFeatures) {
                RegisterCommand("testped", new Action<dynamic, List<dynamic>, string>((source, args, rawCommand) => {
                ...
                RegisterCommand("tattoo", new Action<dynamic, List<dynamic>, string>((source, args, rawCommand) => {
                ...
                RegisterCommand("clearfocus", new Action<dynamic, List<dynamic>, string>((source, args, rawCommand) => { SetNuiFocus(false, false); }), false);
            }

            RegisterCommand("vmenuclient", new Action<dynamic, List<dynamic>, string>((source, args, rawCommand) => {
                if (args != null) {
                    if (args.Count > 0) {
            ...
            if (GetCurrentResourceName() != "vMenu") {
                Exception InvalidNameException =
                    new Exception("\r\n\r\n[vMenu] INSTALLATION ERROR!\r\nThe name of the resource is not valid. Please change the folder name from '" +
                                  GetCurrentResourceName() + "' to 'vMenu' (case sensitive) instead!\r\n\r\n\r\n");
                try {
    ...
    #region Set Permissions function
        ...
        {
            PermissionsManager.SetPermissions(permissionsList);
    ...
    #region Add Menu Function
        ...
        void AddMenu(Menu parentMenu, Menu submenu, MenuItem menuButton)
        {
    ...
    #region Create Submenus
        ...
        void CreateSubmenus()
        {
            ...
            if (IsAllowed(Permission.PVMenu)) {
                ...
                MenuItem button = new MenuItem("Personal Vehicle",
            ...
            if (IsAllowed(Permission.PAMenu)) {
                ...
                MenuItem button2 = new MenuItem("MP Ped Customization",
            ...
            // Add misc settings menu.
            {
                ...
                MenuItem button = new MenuItem("Misc Settings",
    ...
    #region Variables
        ...
        public static Control MenuToggleKey {
            get => MenuController.MenuToggleKey;
            private set => MenuController.MenuToggleKey = value;
        } // M by default (InteractionMenu)
        ...
        public static bool NoClipEnabled {
            get => NoClip.IsNoclipActive();
            set => NoClip.SetNoclipActive(value);
        }
        ...
        public static bool DontOpenMenus {
            ...
            set => MenuController.DontOpenAnyMenu = value;
        }

        public static bool DisableControls {
            get => MenuController.DisableMenuButtons;
            set => MenuController.DisableMenuButtons = value;
        }
