...
namespace vMenuClient {
    public class Recording {
        ...
        void CreateMenu()
        {
            ...
            MenuItem openEditor = new MenuItem("Rockstar Editor",
            ...
            menu.OnItemSelect += async (sender, item, index) => {
                if (item == startRec) {
                    ...
                    DoScreenFadeIn(1);
                    Notify.Alert(
                        "You left your previous session before entering the Rockstar Editor. Restart the game to be able to rejoin the server's main session.");
                }
            };
        }
