...
namespace vMenuClient {
    public class WeaponLoadouts {
        Menu ManageLoadoutMenu = new Menu("Mange Loadout", "Manage saved weapon loadout");

        // Variables
        Menu menu;
        Menu SavedLoadoutsMenu = new Menu("Saved Loadouts", "saved weapon loadouts list");

        Dictionary<string, List<ValidWeapon>> SavedWeapons = new Dictionary<string, List<ValidWeapon>>();
        public bool WeaponLoadoutsSetLoadoutOnRespawn { get; private set; } = UserDefaults.WeaponLoadoutsSetLoadoutOnRespawn;

        string SelectedSavedLoadoutName { get; set; } = "";
        ...
        /// </summary>
        /// <returns></returns>
        Dictionary<string, List<ValidWeapon>> RefreshSavedWeaponsList()
        {
        ...
        public void CreateMenu()
        {
            ...
            MenuCheckboxItem enableDefaultLoadouts = new MenuCheckboxItem("Restore Default Loadout On Respawn",
            ...
            if (IsAllowed(Permission.WLEquipOnRespawn)) {
                ...
                menu.OnCheckboxChange += (sender, checkbox, index, _checked) => { WeaponLoadoutsSetLoadoutOnRespawn = _checked; };
            }
            ...
            MenuItem spawnLoadout = new MenuItem("Equip Loadout",
            ...
            MenuItem setDefaultLoadout = new MenuItem("Set As Default Loadout",
            ...
            MenuItem replaceLoadout = new MenuItem("~r~Replace Loadout",
            ...
            ManageLoadoutMenu.OnItemSelect += async (sender, item, index) => {
                if (SavedWeapons.ContainsKey(SelectedSavedLoadoutName)) {
                    ...
                    {
                        string newName = await GetUserInput("Enter a save name", SelectedSavedLoadoutName.Replace("vmenu_string_saved_weapon_loadout_", ""),
                                                            30);
            ...
            SavedLoadoutsMenu.OnMenuOpen += sender => { RefreshSavedWeaponsMenu(); };
