...
namespace vMenuClient {
    public class WeaponOptions {
        ...
        // Variables
        Menu menu;
        Dictionary<MenuItem, string> weaponComponents;

        Dictionary<Menu, ValidWeapon> weaponInfo;
    ...
    #region Create Menu
        ...
        #region manage creating and accessing addon weapons menu
            if (IsAllowed(Permission.WPSpawn) && AddonWeapons != null && AddonWeapons.Count > 0) {
                ...
                foreach (KeyValuePair<string, uint> weapon in AddonWeapons) {
                    string name = weapon.Key;
                    uint model = weapon.Value;
                    MenuItem item = new MenuItem(name, $"Click to add/remove this weapon ({name}) to/from your inventory.");
                ...
                addonWeaponsBtn.Description =
                    "This option is not available on this server because you don't have permission to use it, or it is not setup correctly.";
            }
        #endregion
        ...
        #region parachute options menu
            if (IsAllowed(Permission.WPParachute)) {
                ...
                MenuItem toggleReserve = new MenuItem("Enable Reserve Parachute",
                ...
                MenuCheckboxItem unlimitedParachutes =
                    new MenuCheckboxItem("Unlimited Parachutes", "Enable unlimited parachutes and reserve parachutes.", UnlimitedParachutes);
                MenuCheckboxItem autoEquipParachutes = new MenuCheckboxItem("Auto Equip Parachutes",
                ...
                MenuListItem smokeColors = new MenuListItem("Smoke Trail Color", smokeColorsList, 0,
