...
namespace vMenuClient {
    public class PersonalVehicle {
        ...
        void CreateMenu()
        {
            ...
            MenuItem toggleEngine = new MenuItem("Toggle Engine",
            ...
            MenuListItem toggleLights = new MenuListItem("Set Vehicle Lights", new List<string> {"Force On", "Force Off", "Reset"}, 0,
            ...
            //MenuItem
            MenuItem lockDoors = new MenuItem("Lock Vehicle Doors",
            ...
            MenuItem toggleAlarm = new MenuItem("Toggle Alarm Sound",
            ...
            MenuCheckboxItem enableBlip =
                new MenuCheckboxItem("Add Blip For Personal Vehicle",
                                     "Enables or disables the blip that gets added when you mark a vehicle as your personal vehicle.", EnableVehicleBlip)
                    {Style = MenuCheckboxItem.CheckboxStyle.Cross};
            MenuCheckboxItem exclusiveDriver =
                new MenuCheckboxItem("Exclusive Driver",
                                     ...
                                     false) {Style = MenuCheckboxItem.CheckboxStyle.Cross};
            //submenu
                ...
                if (veh != null && veh.Exists()) {
                    if (!NetworkHasControlOfEntity(CurrentPersonalVehicle.Handle)) {
                        if (!NetworkRequestControlOfEntity(CurrentPersonalVehicle.Handle)) {
                            Notify.Error(
                                "You currently can't control this vehicle. Is someone else currently driving your car? Please try again after making sure other players are not controlling your vehicle.");
                            return;
                        }
                    }
                    ...
                    Notify.Error(
                        "You have not yet selected a personal vehicle, or your vehicle has been deleted. Set a personal vehicle before you can use these options.");
                }
            };
            ...
            menu.OnCheckboxChange += (sender, item, index, _checked) => {
                if (item == enableBlip) {
                    ...
                    if (EnableVehicleBlip) {
                        ...
                        if (CurrentPersonalVehicle != null && CurrentPersonalVehicle.Exists() && CurrentPersonalVehicle.AttachedBlip != null &&
                            CurrentPersonalVehicle.AttachedBlip.Exists()) {
        ...
        #region Doors submenu
            ...
            List<string> doors = new List<string> {"Front Left", "Front Right", "Rear Left", "Rear Right", "Hood", "Trunk", "Extra 1", "Extra 2", "Bomb Bay"};
        ...
        async void SoundHorn(Vehicle veh)
        {
            if (veh != null && veh.Exists()) {
