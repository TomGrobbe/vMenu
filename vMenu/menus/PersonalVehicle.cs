...
namespace vMenuClient
{
    public class PersonalVehicle
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuListItem toggleStance = new MenuListItem("Vehicle Stance", new List<string>() { "Default", "Lowered" }, 0, "This will increase or decrease your car suspension. Note this will work only with los santos tuners cars.");
