...
namespace vMenuClient {
    public class PlayerOptions {
        Menu CustomDrivingStyleMenu = new Menu("Driving Style", "Custom Driving Style");
        ...
        #region create menu and menu items
            ...
            MenuCheckboxItem unlimitedStaminaCheckbox =
                new MenuCheckboxItem("Unlimited Stamina", "Allows you to run forever without slowing down or taking damage.", PlayerStamina);
            ...
            MenuCheckboxItem noRagdollCheckbox =
                new MenuCheckboxItem("No Ragdoll", "Disables player ragdoll, makes you not fall off your bike anymore.", PlayerNoRagdoll);
            ...
            MenuCheckboxItem playerStayInVehicleCheckbox = new MenuCheckboxItem("Stay In Vehicle",
            ...
            MenuListItem setWantedLevel = new MenuListItem("Set Wanted Level", wantedLevelList, GetPlayerWantedLevel(Game.Player.Handle),
                                                           "Set your wanted level by selecting a value, and pressing enter.");
            MenuListItem setArmorItem = new MenuListItem("Set Armor Type",
                                                         new List<string> {
            ...
            MenuListItem drivingStyle = new MenuListItem("Driving Style", drivingStyles, 0,
            ...
            MenuListItem playerScenarios = new MenuListItem("Player Scenarios", PedScenarios.Scenarios, 0,
            ...
            MenuItem stopScenario = new MenuItem("Force Stop Scenario",
        ...
        #region add items to menu based on permissions
            ...
            if (IsAllowed(Permission.POVehicleAutoPilotMenu)) {
                ...
                MenuItem stopDriving =
                    new MenuItem("Stop Driving",
                ...
                MenuItem forceStopDriving = new MenuItem("Force Stop Driving",
                                                         "This will stop the driving task immediately without finding a suitable place to stop.");
                MenuItem customDrivingStyle = new MenuItem("Custom Driving Style",
                ...
                vehicleAutoPilot.OnItemSelect += async (sender, item, index) => {
                    if (Game.PlayerPed.IsInVehicle() && item != stopDriving && item != forceStopDriving) {
                        if (Game.PlayerPed.CurrentVehicle != null && Game.PlayerPed.CurrentVehicle.Exists() && !Game.PlayerPed.CurrentVehicle.IsDead &&
                            Game.PlayerPed.CurrentVehicle.IsDriveable) {
                    ...
                    if (item == stopDriving) {
                        if (Game.PlayerPed.IsInVehicle()) {
                            ...
                            if (veh != null && veh.Exists() && !veh.IsDead) {
                                ...
                                if (GetNthClosestVehicleNode(Game.PlayerPed.Position.X, Game.PlayerPed.Position.Y, Game.PlayerPed.Position.Z, 3, ref outPos, 0,
                                                             0, 0)) {
        ...
        int GetCustomDrivingStyle()
        {
            List<MenuItem> items = CustomDrivingStyleMenu.GetMenuItems();
        ...
        int GetStyleFromIndex(int index)
        {
            int style;
            switch (index) {
                case 0:
