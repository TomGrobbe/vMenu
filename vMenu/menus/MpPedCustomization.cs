...
namespace vMenuClient.menus
{
    public class MpPedCustomization
    {
        ...
        private readonly MenuListItem setCategoryBtn = new("Set Character Category", new {}, 0, "Sets this character's category. Select to save.");
        private readonly MenuListItem categoryBtn = new("Character Category", new {}, 0, "Sets this character's category.");
