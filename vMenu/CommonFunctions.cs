...
namespace vMenuClient {
    ...
    #region menu position
        public static bool RightAlignMenus()
        {
            return UserDefaults.MiscRightAlignMenu;
        }
    #endregion
    ...
    #region Get Localized Vehicle Display Name
        ...
        /// <returns></returns>
        public static string GetVehDisplayNameFromModel(string name)
        {
    ...
    #region GetVehicleModel (uint)(hash) from Entity/Vehicle (int)
        ...
        public static uint GetVehicleModel(int vehicle)
        {
            ...
            if (player.IsActive || player is InfinityPlayer) {
                ...
                if (inVehicle) {
                    ...
                    if (IsPedInAnyVehicle(playerPed, false)) {
                        ...
                        Vehicle vehicle = GetVehicle(new Player(playerId));
                        if (vehicle != null) {
                            int totalVehicleSeats = GetVehicleModelNumberOfSeats(GetVehicleModel(vehicle.Handle));
        ...
        public static async void KickPlayer(IPlayer player, bool askUserForReason, string providedReason = "You have been kicked.")
        {
            if (player != null) {
                ...
                if (askUserForReason && providedReason == defaultReason) {
                    string userInput = await GetUserInput("Enter Kick Message", 100);
            ...
            if (Game.PlayerPed.IsInVehicle()) {
                ...
                #region colors
                    ...
                    if (updateExistingSavedVehicleName == null) {
                        ...
                        string saveName = await GetUserInput("Enter a save name", 30);
    ...
    #region Load Model
        ...
        static async Task<bool> LoadModel(uint modelHash)
        {
        ...
        public static async void SetLicensePlateCustomText()
        {
            ...
            if (veh != null && veh.Exists()) {
                if (Game.PlayerPed == veh.Driver) {
                    // Get the input.
                    string text = await GetUserInput("Enter License Plate", veh.Mods.LicensePlate ?? "", 8);
    ...
    #region StringToStringArray
        ...
        {
            return Screen.StringToArray(inputString);
        }
    #endregion
    ...
    #region Save Ped Model + Customizations
        ...
        public static async Task<bool> SavePed(string forceName = null, bool overrideExistingPed = false)
        {
            ...
            if (string.IsNullOrEmpty(name)) {
                // Get the save name.
                name = await GetUserInput("Enter a ped save name", 30);
            }
            ...
            if (!string.IsNullOrEmpty(name)) {
                ...
                if (data.isMpPed) {
                    Notify.Alert(
                        "Note, you should probably use the MP Character creator if you want more advanced features. Saving Multiplayer characters with this function does NOT save a lot of the online peds customization.");
                }
    ...
    #region Set Player Walking Style
        ...
        public static async void SetWalkingStyle(string walkingStyle)
        {
            if (IsPedModel(Game.PlayerPed.Handle, (uint) GetHashKey("mp_f_freemode_01")) ||
                IsPedModel(Game.PlayerPed.Handle, (uint) GetHashKey("mp_m_freemode_01"))) {
    ...
    #region Keyfob personal vehicle func
        public static async void PressKeyFob(Vehicle veh)
        {
            ...
            if (player != null && !player.IsDead && !player.Character.IsInVehicle()) {
                ...
                AttachEntityToEntity(KeyFobObject, player.Character.Handle, GetPedBoneIndex(player.Character.Handle, 57005), 0.09f, 0.03f, -0.02f, -76f, 13f,
                                     28f, false, true, true, true, 0, true);
    ...
    #region save player location to the server locations.json file
        ...
        public static async void SavePlayerLocationToLocationsFile()
        {
            ...
            if (ConfigManager.GetTeleportLocationsData().Any(loc => loc.name == locationName)) {
                Notify.Error("This location name is already used, please use a different name.");
                return;
            }

            TriggerServerEvent("vMenu:SaveTeleportLocation", JsonConvert.SerializeObject(new ConfigManager.TeleportLocation(locationName, pos, heading)));
    ...
    #endregion
    #region Variables
        static string _currentScenario = "";
        static Vehicle _previousVehicle;
    ...
    #region DoesModelExist
        ...
        /// <returns></returns>
        public static bool DoesModelExist(string modelName)
        {
            return DoesModelExist((uint) GetHashKey(modelName));
        }
        ...
        /// <returns></returns>
        public static bool DoesModelExist(uint modelHash)
        {
    ...
    #region Is ped pointing
        ...
        public static bool GetPointingIsBlocked()
        {
            ...
            float heading = MathUtil.Clamp(rawHeading, -180.0f, 180.0f);
            heading += 180.0f;
            heading /= 360.0f;
            ...
            if (MainMenu.DebugMode) {
                if (hit) {
                    ...
                    DrawMarker(28, pos1.X, pos1.Y, pos1.Z, 0f, 0f, 0f, 0f, 0f, 0f, 0.4f, 0.4f, 0.4f, 123, 53, 200, 128, false, false, 0, false, null, null,
                               false);
                }

                DrawLine(pos1.X, pos1.Y, pos1.Z - 0.2f, pos1.X, pos1.Y, pos1.Z + 0.2f, 255, 0, 0, 255);
                DrawTextOnScreen("Blocking: " + hit, 0f, 0f);
            }
    ...
    #region Spectate function
        static int currentlySpectatingPlayer = -1;
            ...
            if (forceDisable) {
                ...
                if (player.Handle == Game.Player.Handle) {
                    if (NetworkIsInSpectatorMode()) {
                        ...
                        NetworkSetInSpectatorMode(false, 0); // disable spectating.
                        DoScreenFadeIn(500);
                        Notify.Success("Stopped spectating.", false);
                        currentlySpectatingPlayer = -1;
                    }
                    else {
                        Notify.Error("You can't spectate yourself.", false);
                    }
                }
                else {
                    if (NetworkIsInSpectatorMode()) {
                        if (currentlySpectatingPlayer != player.Handle && player.Character != null) {
                            ...
                            DoScreenFadeIn(500);
                            Notify.Success($"You are now spectating ~g~<C>{GetSafePlayerName(player.Name)}</C>~s~.", false);
        ...
        public static async void SpawnVehicle(string vehicleName = "custom", bool spawnInside = false, bool replacePrevious = false)
        {
            if (vehicleName == "custom") {
                ...
                if (!string.IsNullOrEmpty(result)) {
                    ...
                    SpawnVehicle(model, spawnInside, replacePrevious, false, new VehicleInfo());
                }
                // Result was invalid.
                else {
                    Notify.Error(CommonErrors.InvalidInput);
            ...
            // Spawn the specified vehicle.
                ...
                SpawnVehicle((uint) GetHashKey(vehicleName), spawnInside, replacePrevious, false,
                             new VehicleInfo());
            }
        }
    #endregion
    ...
    #region Main Spawn Vehicle Function
                                              ...
                                              string saveName = null)
        {
            ...
            if (_previousVehicle != null) {
                ...
                if (_previousVehicle.Exists() && _previousVehicle.PreviouslyOwnedByPlayer &&
                    ...
                    // Otherwise
                        ...
                        if (!ConfigManager.GetSettingsBool(ConfigManager.Setting.vmenu_keep_spawned_vehicles_persistent)) {
            ...
            if (Game.PlayerPed.IsInVehicle() && (replacePrevious || !IsAllowed(Permission.VSDisableReplacePrevious))) {
                if (GetVehicle().Driver == Game.PlayerPed) // && IsVehiclePreviouslyOwnedByPlayer(GetVehicle()))
                {
                    ...
                    tmpveh.Delete();
                    Notify.Info(
                        "Your old car was removed to prevent your new car from glitching inside it. Next time, get out of your vehicle before spawning a new one if you want to keep your old one.");
                }
            }
            ...
            Log(
                $"New vehicle, hash:{vehicleHash}, handle:{vehicle.Handle}, force-re-save-name:{saveName ?? "NONE"}, created at x:{pos.X} y:{pos.Y} z:{pos.Z + 1f} " +
                $"heading:{heading}");
        ...
        static async void ApplyVehicleModsDelayed(Vehicle vehicle, VehicleInfo vehicleInfo, int delay)
        {
            if (vehicle != null && vehicle.Exists()) {
                ...
                vehicle.Mods.NeonLightsColor = Color.FromArgb(vehicleInfo.colors["neonR"], vehicleInfo.colors["neonG"], vehicleInfo.colors["neonB"]);
    ...
    #region GetUserInput
        ...
        {
            return await GetUserInput(null, null, 30);
        }
        ...
        /// <returns></returns>
        public static async Task<string> GetUserInput(int maxInputLength)
        {
            return await GetUserInput(null, null, maxInputLength);
        }
        ...
        /// <returns></returns>
        public static async Task<string> GetUserInput(string windowTitle)
        {
            return await GetUserInput(windowTitle, null, 30);
        }
        ...
        /// <param name="maxInputLength"></param>
        /// <returns></returns>
        public static async Task<string> GetUserInput(string windowTitle, int maxInputLength)
        {
            return await GetUserInput(windowTitle, null, maxInputLength);
        }
        ...
        /// <returns></returns>
        public static async Task<string> GetUserInput(string windowTitle, string defaultText)
        {
            return await GetUserInput(windowTitle, defaultText, 30);
        }
    ...
    #region Weather Sync
        ...
        /// <summary>
        ///     Modify the clouds for everyone. If removeClouds is true, then remove all clouds. If it's false, then randomize the
        ///     clouds.
        /// </summary>
        /// <param name="removeClouds">
        ///     Removes the clouds from the sky if true, otherwise randomizes the clouds type for all
        ///     players.
        /// </param>
        public static void ModifyClouds(bool removeClouds)
        {
    ...
    #region Hud Functions
        ...
        {
            DrawTextOnScreen(text, xPosition, yPosition, 0.48f);
        }
        ...
        {
            DrawTextOnScreen(text, xPosition, yPosition, size, Alignment.Left);
        }
        ...
        public static void DrawTextOnScreen(string text, float xPosition, float yPosition, float size, Alignment justification)
        {
        ...
        public static void DrawTextOnScreen(string text, float xPosition, float yPosition, float size, Alignment justification, int font)
        {
        ...
        public static void DrawTextOnScreen(string text, float xPosition, float yPosition, float size, Alignment justification, int font,
                                            bool disableTextOutline)
        {
            if (IsHudPreferenceSwitchedOn() && Hud.IsVisible && !MainMenu.MiscSettingsMenu.HideHud && !IsPlayerSwitchInProgress() && IsScreenFadedIn() &&
                !IsPauseMenuActive() && !IsFrontendFading() && !IsPauseMenuRestarting() && !IsHudHidden()) {
                SetTextFont(font);
    ...
    #region Set Player Skin
        ...
        /// </summary>
        /// <param name="modelName">The model name.</param>
        public static async Task SetPlayerSkin(string modelName, PedInfo pedCustomizationOptions, bool keepWeapons = true)
        {
            await SetPlayerSkin((uint) GetHashKey(modelName), pedCustomizationOptions, keepWeapons);
        }
        ...
        {
            string input = await GetUserInput("Enter Ped Model Name", 30);
    ...
    #region Weapon Options
        ...
        {
            string inputAmmo = await GetUserInput("Enter Ammo Amount", "100");
        ...
        {
            int ammo = 900;
            string inputName = await GetUserInput("Enter Weapon Model Name", 30);
    ...
    #region Weapon Loadouts
        ...
        public static List<ValidWeapon> GetSavedWeaponLoadout(string saveName)
        {
            ...
            string kvp = GetResourceKvpString(saveName.StartsWith("vmenu_string_saved_weapon_loadout_")
                                                  ? saveName
                                                  : "vmenu_string_saved_weapon_loadout_" + saveName);
        ...
        public static async Task SpawnWeaponLoadoutAsync(string saveName, bool appendWeapons, bool ignoreSettingsAndPerms, bool dontNotify)
        {
            ...
            if (!ignoreSettingsAndPerms && saveName == "vmenu_temp_weapons_loadout_before_respawn") {
                ...
                if (MainMenu.WeaponLoadoutsMenu == null || !MainMenu.WeaponLoadoutsMenu.WeaponLoadoutsSetLoadoutOnRespawn ||
    ...
    #region Draw model dimensions math util functions
        ...
        */
        ...
        /// <summary>
        ///     Gets the bounding box of the entity model in world coordinates, used by
        ///     <see cref="DrawEntityBoundingBox(Entity, int, int, int, int)" />.
        /// </summary>
        ...
        /// <param name="b"></param>
        /// <param name="a"></param>
        static void DrawBoundingBox(Vector3[] box, int r, int g, int b, int a)
        {
        ...
        /// <param name="box"></param>
        /// <returns></returns>
        static Vector3[][] GetBoundingBoxPolyMatrix(Vector3[] box)
        {
        ...
        /// <param name="box"></param>
        /// <returns></returns>
        static Vector3[][] GetBoundingBoxEdgeMatrix(Vector3[] box)
        {
            return new Vector3[12][] {
        ...
        /// <param name="b"></param>
        /// <param name="a"></param>
        static void DrawPolyMatrix(Vector3[][] polyCollection, int r, int g, int b, int a)
        {
        ...
        /// <param name="b"></param>
        /// <param name="a"></param>
        static void DrawEdgeMatrix(Vector3[][] linesCollection, int r, int g, int b, int a)
        {
    ...
    #region Map (math util) function
        /// <summary>
        ///     Maps the <paramref name="value" /> (which is a value between <paramref name="min_in" /> and
        ///     <paramref name="max_in" />) to a new value in the range of <paramref name="min_out" /> and
        ///     <paramref name="max_out" />.
        /// </summary>
    ...
    #region Private message notification
        public static void PrivateMessage(string source, string message)
        {
            PrivateMessage(source, message, false);
        }
