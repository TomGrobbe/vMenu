...
public static class PlayerNoClipState
{
    ...
    {
        // Somebody without the permission cannot be in noclip, so a claim that they are is either a stale
        // message from a revoke or somebody trying it on. Either way they are visible. Not logged as a
        // warning, because a revoke racing a toggle is normal.
