...
internal static class EnglishStrings
{
    internal static LanguageTable Table { get; } = new(
        ...
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            [Loc.World.StatusWeatherForced] = "~y~{weather}~s~ (forced) · ~b~{time}~s~",
            [Loc.World.StatusTimeForced] = "~b~{weather}~s~ · ~y~{time}~s~ (shifted)",
            [Loc.World.StatusBothForced] = "~y~{weather}~s~ (forced) · ~y~{time}~s~ (shifted)",
