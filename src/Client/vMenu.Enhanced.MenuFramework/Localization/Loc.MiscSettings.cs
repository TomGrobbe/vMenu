...
public static partial class Loc
{
    ...
    {
        public const string Title = "miscsettings.title";

        public const string Subtitle = "miscsettings.subtitle";

        public const string LinkDescription = "miscsettings.link.desc";
