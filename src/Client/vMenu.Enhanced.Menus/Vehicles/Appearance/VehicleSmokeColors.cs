...
/// <summary>One tyre smoke colour.</summary>
...
{
    /// <summary>What the game reads as no tyre smoke at all.</summary>
    public const int OffRed = 255;

    /// <inheritdoc cref="OffRed"/>
    ...
    /// <summary>Whether this colour is the game's way of saying there is no smoke.</summary>
    public static bool IsOff(int red, int green, int blue) =>
        red == OffRed && green == OffGreen && blue == OffBlue;

    /// <summary>The matching colour's position, or -1 for one mixed by hand.</summary>
