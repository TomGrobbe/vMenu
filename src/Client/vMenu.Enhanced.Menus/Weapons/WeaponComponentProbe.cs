...
/// <summary>
/// Which components a weapon actually takes, asked of the game rather than declared anywhere.
/// </summary>
// Probed on first open and kept, not built up front: the config lists a few hundred components and
// the menu holds a hundred weapons, so asking about every pair at startup would be tens of thousands
// of native calls for weapons nobody opens.
internal static class WeaponComponentProbe
{
    ...
    /// <summary>Call when the component list is replaced, so a stale probe is not kept.</summary>
